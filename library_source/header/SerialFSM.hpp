...
public:
    ...
    std::atomic<int> currentCommandsToArduino;
    std::atomic<int> nackCount, ackCount;
    ...
    SerialFSM();
    SerialFSM(const SerialFSM &other);
    SerialFSM(SerialFSM &&other);
    SerialFSM &operator=(const SerialFSM &other);
    SerialFSM &operator=(SerialFSM &&other);
    void Execute(char c);
    void resetVariables();
    void clearMsg();
