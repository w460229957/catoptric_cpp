...
struct Message
{
    ...
    Message(int mirrorRow, int mirrorColumn, int motorNumber, int direction,
        ...
        : Message(mirrorRow, mirrorColumn, motorNumber, direction,
                  position, 0, 0){};
    Message(int mirrorRow, int mirrorColumn, int motorNumber, int position) : Message(mirrorRow, mirrorColumn, motorNumber, 0, position){};
...
public:
    ...
    CatoptricRow(int & rowNum, int & numMirrors);
    CatoptricRow(const CatoptricRow &other);
    CatoptricRow(CatoptricRow &&other);
    CatoptricRow &operator=(const CatoptricRow &other);
    CatoptricRow &operator=(CatoptricRow &&other);
