...
#include <Catoptric_MS_PWMServoDriver.h>
...
*/
/**************************************************************************/
Catoptric_MotorShield::Catoptric_MotorShield(uint8_t addr) {
  _addr = addr;
  _pwm = Catoptric_MS_PWMServoDriver(_addr);
}
...
*/
/**************************************************************************/
void Catoptric_MotorShield::begin(uint16_t freq, TwoWire *theWire) {
  Serial.println("Entered library .begin()");
  Serial.print("i2c defined as: ");
  if (! theWire) {
  ...
  // init PWM w/_freq
  _i2c->begin();
  Serial.println("i2c->begin() successful");
  _pwm.begin();//_pwn does not work properly.
  Serial.println("pwm->begin() successful");
...
*/
/**************************************************************************/
void Catoptric_MotorShield::setPWM(uint8_t pin, uint16_t value) {
  if (value > 4095) {
...
*/
/**************************************************************************/
void Catoptric_MotorShield::setPin(uint8_t pin, boolean value) {
  if (value == LOW)
    _pwm.setPWM(pin, 0, 0);
  else
    _pwm.setPWM(pin, 4096, 0);
...
*/
/**************************************************************************/
Catoptric_StepperMotor *Catoptric_MotorShield::getStepper(uint16_t steps, uint8_t num) {
...
*/
/**************************************************************************/
Catoptric_StepperMotor::Catoptric_StepperMotor(void) {
...
*/
/**************************************************************************/
void Catoptric_StepperMotor::setSpeed(uint16_t rpm) {
...
*/
/**************************************************************************/
void Catoptric_StepperMotor::release(void) {
...
*/
/**************************************************************************/
void Catoptric_StepperMotor::step(uint16_t steps, uint8_t dir,  uint8_t style) {
...
*/
/**************************************************************************/
uint8_t Catoptric_StepperMotor::onestep(uint8_t dir, uint8_t style) {
  uint8_t a, b, c, d;
  uint8_t ocrb, ocra;
